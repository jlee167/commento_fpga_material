...
--               Lee/Desktop/commento/commento_fpga_material/LiveClass/week6/week6/week6.gen/sources_1/ip/gtwizard_0/gtwizard_0_sim_netlist.vhdl}
-- Design      : gtwizard_0
...
architecture STRUCTURE of gtwizard_0_sync_pulse is
...
sync_qplllock: entity work.gtwizard_0_sync_block_10
     port map (
...
architecture STRUCTURE of gtwizard_0_TX_MANUAL_PHASE_ALIGN is
...
\cdc[0].sync_TXDLYSRESETDONE\: entity work.gtwizard_0_sync_block_5
     port map (
      data_out => txdlysresetdone_sync,
      data_sync_reg1_0 => data_sync_reg1,
      sysclk_in => sysclk_in
    );
\cdc[0].sync_TXPHALIGNDONE\: entity work.gtwizard_0_sync_block_6
     port map (
...
\cdc[0].sync_TXPHINITDONE\: entity work.gtwizard_0_sync_pulse
     port map (
      D(0) => D(0),
...
sync_cplllock: entity work.gtwizard_0_sync_block_0
     port map (
...
entity gtwizard_0_init is
  ...
  attribute RX_CDRLOCK_TIME of gtwizard_0_init : entity is "16835.016835";
  ...
  attribute WAIT_TIME_CDRLOCK of gtwizard_0_init : entity is 1684;
end gtwizard_0_init;
...
gt0_tx_manual_phase_i: entity work.gtwizard_0_TX_MANUAL_PHASE_ALIGN
     port map (
...
entity gtwizard_0 is
  ...
  attribute X_CORE_INFO of gtwizard_0 : entity is "gtwizard_0,gtwizard_v3_6_13,{protocol_file=hdmi}";
end gtwizard_0;
