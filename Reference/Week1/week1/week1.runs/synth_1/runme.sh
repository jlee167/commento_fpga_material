...
HD_PWD='C:/Users/Jihoon Lee/Desktop/commento/commento_fpga_material/Reference/Week1/week1/week1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log gray_encoder.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source gray_encoder.tcl
