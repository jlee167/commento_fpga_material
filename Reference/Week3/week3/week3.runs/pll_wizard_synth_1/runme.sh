...
HD_PWD='C:/Users/Jihoon Lee/Desktop/commento/week3/week3.runs/pll_wizard_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log pll_wizard.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source pll_wizard.tcl
