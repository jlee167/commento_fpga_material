...
HD_PWD='C:/Users/Jihoon Lee/Desktop/commento/commento_fpga_material/Reference/Week4/week4/week4.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log if_spi.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source if_spi.tcl
